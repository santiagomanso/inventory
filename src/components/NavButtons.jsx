...
export const NavButtons = () => {
    ...
    return (
        <div className='ml-0 sm:ml-36 mr-0 sm:mr-36 flex flex-col sm:flex-row justify-center items-center flex-wrap'>
            <div className='m-2 sm:m-4 h-16 sm:h-64 w-64 bg-stone-200 rounded-lg'>
            ...
            <div className='m-2 sm:m-4 h-16 sm:h-64 w-64 bg-stone-200 rounded-lg'>
                <button className='font-bold text-xl h-full w-full' onClick={()=>{navigate('./backup-shelfs')}}>Backup Shelfs</button>
            </div>
            <div className='m-2 sm:m-4 h-16 sm:h-64 w-64 bg-stone-200 rounded-lg'>
